...
<body>
         ...
         <div class="sticky" id="sticky">
           ...
           <a onclick="session2()" href="#">signout</a>
        </div>
...
<script>
    ...
    var quantity=[];
    var sessio_id=<?php echo $_SESSION['id'];?>;
 
   change();
    function change(){ 
         document.getElementById("test2").innerHTML=sessio_id;
         if(sessio_id===1){
            var login=document.getElementsByClassName("login");
            login[0].style.display="none";
            login[1].style.display="none";
            document.getElementById("logged").style.display="inline";
            //document.getElementById("logged").innerHTML="hii";
         }
    ...
    function add(n){
        ...
        if(j==true){
            document.getElementById("id01").innerHTML="included";
        }else{
        product.push(l);
        quantity.push(q);
