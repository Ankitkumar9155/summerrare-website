...
<body>
         ...
         <div class="sticky" id="sticky">
           ...
           <a onclick="shop()" href="show.php" id="shop" ><i class='fas fa-shopping-cart' style='font-size:24px'></i> cart()</a>
    ...
    <form id="selected" method="post" action="selected_item.php">
        <input type="number" id="id01" name="userid" value="echo $_SESSION['personid'];">
        <input type="number" id="id02" name="quantity" value="1">
        <input type="number" id="id03" name="productid" >
    </form>
...
<script>
    ...
    function add(n){
        ...
        var shop="cart"+"("+length+")";
         document.getElementById("id03").value=l;
        document.getElementById("id02").value=plus(l);
